...
public class SupplierPaymentItemsHistory implements Initializable {
    ...
    private void showPaymentHistoryPage() throws IOException {
        innerPane= FXMLLoader.load(getClass().getResource("/view/History/SupplierPaymentHistory.fxml"));
